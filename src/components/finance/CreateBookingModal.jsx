...
export default function BookingsAndExpenses() {
  ...
  return (
    <div className="p-6 space-y-6"> 
      ...
      {showCreateModal && (
         <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-transparent overflow-x-hidden overflow-y-auto">
    <div className="w-full max-w-[calc(100vw-2rem)] md:max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-hidden bg-white rounded-lg p-6">
      ...
      {showExpenseModal && (
       <div className="fixed inset-0 bg-white/10 backdrop-blur-[2px] overflow-x-hidden flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-hidden">
